...
**DiGi.SAM** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.SAM.Analytical](DiGi.SAM.Analytical)** (Path: `DiGi.SAM\DiGi.SAM.Analytical`)
* **[DiGi.SAM.Geometry](DiGi.SAM.Geometry)** (Path: `DiGi.SAM\DiGi.SAM.Geometry`)
